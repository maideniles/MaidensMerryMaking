...
public class  ChristmasPineTreeMedium extends AbstractTreeFeature<NoFeatureConfig> {
    ...
    public ChristmasPineTreeMedium(Function<Dynamic<?>, ? extends NoFeatureConfig> p_i51429_1_, boolean p_i51429_2_) {

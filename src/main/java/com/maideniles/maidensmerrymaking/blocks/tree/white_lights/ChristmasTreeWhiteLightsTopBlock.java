package com.maideniles.maidensmerrymaking.blocks.tree.white_lights;
...
public class ChristmasTreeWhiteLightsTopBlock extends BushBlock {

    protected static final VoxelShape SHAPE = Block.makeCuboidShape(2.0D, 0.0D, 2.0D, 14.0D, 16.0D, 14.0D);

    public ChristmasTreeWhiteLightsTopBlock(Block.Properties properties) {
        super(properties);
    ...
    public boolean isValidGround(BlockState state, IBlockReader worldIn, BlockPos pos) {
        ...
        return block == ModBlocks.CHRISTMAS_TREE_WHITE_LIGHTS_MIDDLE.get()
                || block == ModBlocks.CHRISTMAS_TREE_MIDDLE.get();
    ...
    public void onBlockHarvested(World worldIn, BlockPos pos, BlockState state, PlayerEntity player) {
        ...
        if (blockstate.getBlock() == this && blockstate2.getBlock() == ModBlocks.CHRISTMAS_TREE_WHITE_LIGHTS_MIDDLE.get()
        || blockstate2.getBlock() == ModBlocks.CHRISTMAS_TREE_MIDDLE.get()
        || blockstate2.getBlock() == ModBlocks.CHRISTMAS_TREE_MULTI_LIGHTS_MIDDLE.get()) {

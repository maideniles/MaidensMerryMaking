...
public class ChristmasTreeWhiteLightsMiddleBlock extends BushBlock {

    protected static final VoxelShape SHAPE = Block.makeCuboidShape(2.0D, 0.0D, 2.0D, 14.0D, 16.0D, 14.0D);

    public ChristmasTreeWhiteLightsMiddleBlock(Block.Properties properties) {
        super(properties);
   ...
   // }
    ...
    public void onBlockHarvested(World worldIn, BlockPos pos, BlockState state, PlayerEntity player) {
        ...
        || blockstate2.getBlock() == ModBlocks.CHRISTMAS_TREE_BOTTOM.get()

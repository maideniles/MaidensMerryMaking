...
public class GingerRoot extends CropsBlock implements IGrowable {
    ...
    public GingerRoot(Block.Properties builder) {
        super(builder);
    ...
    public boolean onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        ...
        if (!flag && player.getHeldItem(handIn).getItem() == Items.BONE_MEAL) {
            ...
            spawnAsEntity(worldIn, pos, new ItemStack(ModItems.GINGER_TUBER.get(), j + (flag ? 1 : 0)));
    ...
    protected IItemProvider getSeedsItem() {
        return ModItems.GINGER_TUBER.get();
    }

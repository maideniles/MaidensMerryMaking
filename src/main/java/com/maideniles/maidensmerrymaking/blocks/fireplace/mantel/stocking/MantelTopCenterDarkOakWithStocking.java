...
public class MantelTopCenterDarkOakWithStocking extends HorizontalDecoBlock {
    ...
    public MantelTopCenterDarkOakWithStocking(Properties properties) {
        super(properties);
    }
    ...
    public boolean onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        ...
        if (!worldIn.isRemote()) {
            ...
            if (player.isSneaking() && stocking.isEmpty()) {
                ...
                worldIn.setBlockState(pos, ModBlocks.MANTEL_DARK_OAK_TOP_MIDDLE.get().getDefaultState().with(DIRECTION, state.get(DIRECTION)));
            }
        }
        return true;
    }
    ...
    public void onBlockHarvested(World worldIn, BlockPos pos, BlockState state, PlayerEntity player) {
        ...
        if (blockstate.getBlock() == this && blockstate1.getBlock() == ModBlocks.MANTEL_DARK_OAK_TOP_RIGHT.get()
                || blockstate1.getBlock() == ModBlocks.MANTEL_DARK_OAK_TOP_RIGHT_STOCKING.get()
                || blockstate.getBlock() == this && blockstate2.getBlock() == ModBlocks.MANTEL_DARK_OAK_TOP_RIGHT.get()
                || blockstate2.getBlock() == ModBlocks.MANTEL_DARK_OAK_TOP_RIGHT_STOCKING.get() ){
        ...
        if (blockstate.getBlock() == this && blockstate3.getBlock() == ModBlocks.MANTEL_DARK_OAK_TOP_RIGHT.get()

                || blockstate3.getBlock() == ModBlocks.MANTEL_DARK_OAK_TOP_RIGHT_STOCKING.get()
                || blockstate.getBlock() == this && blockstate4.getBlock() == ModBlocks.MANTEL_DARK_OAK_TOP_RIGHT.get()

                || blockstate4.getBlock() == ModBlocks.MANTEL_DARK_OAK_TOP_RIGHT_STOCKING.get()){
        ...
        ItemEntity mantel = new ItemEntity(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ModBlocks.MANTEL_DARK_OAK_NORMAL.get(), 1));

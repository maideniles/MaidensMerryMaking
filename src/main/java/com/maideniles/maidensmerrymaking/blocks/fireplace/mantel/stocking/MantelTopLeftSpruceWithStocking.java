...
public class MantelTopLeftSpruceWithStocking extends HorizontalDecoBlock {
    ...
    public MantelTopLeftSpruceWithStocking(Properties properties) {
        super(properties);
    ...
    public boolean isValidPosition(BlockState state, IWorldReader worldIn, BlockPos pos) {
        ...
        return block == ModBlocks.MANTEL_SPRUCE_LEG_LEFT.get();
    }
    ...
    public boolean onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        ...
        if (!worldIn.isRemote()) {
            ...
            if (player.isSneaking() && stocking.isEmpty()) {
                ...
                worldIn.setBlockState(pos, ModBlocks.MANTEL_SPRUCE_TOP_LEFT.get().getDefaultState().with(DIRECTION, state.get(DIRECTION)));
            }
        }
        return true;
    }
    ...
    public void onBlockHarvested(World worldIn, BlockPos pos, BlockState state, PlayerEntity player) {
        ...
        worldIn.addEntity(stocking); //SPAWN THE MANTEL_SPRUCE//

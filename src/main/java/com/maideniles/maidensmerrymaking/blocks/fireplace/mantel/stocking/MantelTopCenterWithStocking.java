...
public class MantelTopCenterWithStocking extends HorizontalDecoBlock {
    ...
    public void onBlockHarvested(World worldIn, BlockPos pos, BlockState state, PlayerEntity player) {
        ...
        if (blockstate.getBlock() == this && blockstate3.getBlock() == ModBlocks.MANTEL_TOP_RIGHT.get()
        ...
        ItemEntity mantel = new ItemEntity(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ModBlocks.MANTEL_NORMAL.get(), 1));

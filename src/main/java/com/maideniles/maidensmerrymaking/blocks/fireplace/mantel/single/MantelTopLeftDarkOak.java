...
public class MantelTopLeftDarkOak extends HorizontalDecoBlock {
    ...
    public MantelTopLeftDarkOak(Properties properties) {
        super(properties);
    ...
    public boolean onBlockActivated(BlockState state, World worldIn, BlockPos pos, PlayerEntity player, Hand handIn, BlockRayTraceResult hit) {
        ...
        if (!worldIn.isRemote()) {
            ...
            if (stocking.getItem() == ModItems.STOCKING.get()) {
                ...
                worldIn.setBlockState(pos, ModBlocks.MANTEL_DARK_OAK_TOP_LEFT_STOCKING.get().getDefaultState().with(DIRECTION, state.get(DIRECTION)));
